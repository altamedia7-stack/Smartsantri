...
export function UserDashboard({ profile }: { profile: UserProfile }) {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-24 sm:pb-8">
      {activeTab === 'home' && (
        <>
          <div className="bg-gradient-to-br from-green-600 via-green-600 to-green-700 px-8 py-14 sm:px-10 lg:px-12 shadow-md relative -mx-4 sm:-mx-6 lg:-mx-8 mt-0 mb-8 border-b border-green-500/20">
